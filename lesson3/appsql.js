...
var pool=mysql.createPool({
        ...
        user: 'root',
        password: '123456',
        database:'weathers', // 前面建的cdweather表位于些数据库中
        port: 3306
});
          ...
          json+="]";
           ...
           var jsonWrite = function (res, ret) {
	        ...
	        pool.getConnection(function(err,connection){
                 ...
                 var myquery;
                 //console.log(jsonDa);
                  /* INSERT INTO cdweather (monpoint,aqi,aqiC,pripoll,
                    pm25fm, pm10i, co, no2,1o3,8o3,so2)VALUES(jsonDa[i].监测点,jsonDa[i].AQI,jsonDa[i].空气质量
                   指数类别,jsonDa[i].首要污染物,jsonDa[i].PM2.5细颗粒物,jsonDa[i].PM10可吸入颗粒物,jsonDa[i].CO
                    一氧化碳,jsonDa[i].NO2二氧化氮,jsonDa[i].O3臭氧1小时平均,jsonDa[i].O3臭氧8小时平均,jsonDa[i].SO2
                      二氧化硫*/
